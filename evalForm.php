...
<body>
  ...
  <table>
    ...
    <tr id="row-2">
      <!-- 2nd Row - Leadership -->
      <td class="cells-contrast">LEADERSHIP</td>
    ...
    <tr id="row-3">
      ...
      <td class="cells">PARTICIPATION</td>
      <td class="cells">
    ...
    <tr>
      ...
      <td class="cells-contrast">PROFESSIONALISM</td>
      <td class="cells-contrast">
